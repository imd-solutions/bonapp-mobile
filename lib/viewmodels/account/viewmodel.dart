...
class AccountViewModel extends BaseModel {
  ...
  Future<void> _getDropdownInformation() async {
    ...
    selectedNationality = user.profile.nationality.id != '' ? int.parse(user.profile.nationality.id) : 0;
    selectedNationalityName = user.profile.nationality.id != '' ? user.profile.nationality.name : 'Please select';
