                ...
                (index) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: index == 8
                          ? DecorationImage(
                              image: AssetImage('assets/images/coffee_free.png'),
                              fit: BoxFit.fill,
                            )
                          : DecorationImage(
                              image: AssetImage('assets/images/coffee_free_${index}.png'),
                              fit: BoxFit.fill,
                            ),
                    ),
                  );
                ...
                (index) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      image: index == 8
                          ? DecorationImage(
                              image: AssetImage('assets/images/lunch_free.png'),
                              fit: BoxFit.fill,
                            )
                          : DecorationImage(
                              image: AssetImage('assets/images/lunch_free_${index}.png'),
                              fit: BoxFit.fill,
                            ),
                    ),
                  );
